    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div
        className={`max-w-md w-full p-8 bg-white rounded-lg shadow-lg border-l-4 ${
          isSuccess ? "border-[#5b9cb9]" : "border-yellow-500"
        }`}
      >
        <div className="flex items-center mb-6">
          <div className="shrink-0">
            {isSuccess ? (
              <svg
                className="h-12 w-12 text-[#5b9cb9]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          <div className="ml-4">
            <h2
              className={`text-2xl font-bold ${
                isSuccess ? "text-[#599bba]" : "text-yellow-700"
              }`}
            >
        ...
        {paymentStatus && (
          <div className="space-y-3 mb-6 bg-gray-50 p-4 rounded-lg">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-semibold">{paymentStatus.order_id}</span>
            </div>
            <div className="flex justify-between text-sm">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span
                className={`font-semibold ${
                  isSuccess ? "text-[#000000]" : "text-yellow-600"
                }`}
              >
                OK
              </span>
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-semibold">{paymentStatus.sp_message}</span>
            </div>
          </div>
        )}
        ...
        <button
          onClick={() => (window.location.href = "/")}
          className={`w-full cursor-pointer text-white py-3 px-4 rounded-lg transition-colors font-medium ${
            isSuccess
              ? "bg-[#5b9cb9] hover:bg-[#4a97bb]"
